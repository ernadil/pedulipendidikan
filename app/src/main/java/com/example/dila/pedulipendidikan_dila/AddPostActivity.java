...
public class AddPostActivity extends AppCompatActivity {
    ...
    EditText mTitlePost, mJumlah, mLokasi, mDeskripsi ;
    ImageView imageView;
    Button mChooseImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mJumlah = (EditText) findViewById(R.id.et_jumlah_post);
        mLokasi = (EditText)findViewById(R.id.et_lokasi_post);
        mDeskripsi = (EditText)findViewById(R.id.et_deskripsi_post);
    ...
    public void add(View view) {
        ...
        databaseUser.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                final String jumlah = mJumlah.getText().toString();
                final String lokasi = mLokasi.getText().toString();
                    ...
                    image.putFile(imageUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> uploadTask) {
                            ...
                            if (uploadTask.isSuccessful()) {
                                ...
                                Post post = new Post(id, userId, name, download_url, title, jumlah, lokasi, deskripsi);
